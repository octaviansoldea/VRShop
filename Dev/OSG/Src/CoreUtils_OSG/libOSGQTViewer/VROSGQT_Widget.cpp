...
OSGQT_Widget::OSGQT_Widget(QWidget* parent,const QGLWidget* shareWidget,Qt::WindowFlags f) : 
QGLWidget(parent,shareWidget,f)	{
	graphicsWindow_ =  new osgViewer::GraphicsWindowEmbedded(x(),y(),width(),height());
...
OSGQT_Widget::OSGQT_Widget( const QGLFormat & format, QWidget * parent, const QGLWidget * shareWidget, Qt::WindowFlags f )
...
{
	m_viewer.frame(USE_REFERENCE_TIME);
}
