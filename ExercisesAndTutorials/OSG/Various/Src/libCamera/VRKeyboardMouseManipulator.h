...
namespace VR {
	...
	class KeyboardMouseManipulator : public osgGA::StandardManipulator
	{
		bool m_bUFO;
	public:
		...
		KeyboardMouseManipulator( const KeyboardMouseManipulator& om,
	...
	public:
		...
		META_Object( VR, KeyboardMouseManipulator );
	...
	}; // class KeyboardMouseManipulator
	...
	inline double KeyboardMouseManipulator::getTrackballSize() const  { return _trackballSize; }
	/** Get the mouse wheel zoom factor.*/
	inline double KeyboardMouseManipulator::getWheelZoomFactor() const  { return _wheelZoomFactor; }
