...
void OSGCameraManipulator::initUFO() {
...
void OSGCameraManipulator::getUsage(osg::ApplicationUsage& usage) const
{
...
void OSGCameraManipulator::_adjustPosition()
{
	if( !_node.valid() )
		return;
...
void OSGCameraManipulator::getCurrentPositionAsLookAt( osg::Vec3d& eye, osg::Vec3d& center, osg::Vec3d& up )
{
	eye = _position;
...
void OSGCameraManipulator::setByMatrixOrbit( const osg::Matrixd& matrix )
{
...
/** Set the position of the manipulator using a 4x4 matrix.*/
void OSGCameraManipulator::setByInverseMatrixOrbit( const osg::Matrixd& matrix )
{
...
osg::Matrixd OSGCameraManipulator::getMatrixOrbit() const
{
...
osg::Matrixd OSGCameraManipulator::getInverseMatrixOrbit() const
{
...
//
//
//void OSGCameraManipulator::updateUFOTrackball() {
//	setTransformation(_homeEye, _center, _homeUp);
//	//setByMatrixTrackball(getMatrixUFO());
//	//setByInverseMatrixTrackball(getInverseMatrixUFO());
//}
//
//void OSGCameraManipulator::updateTrackballUFO() {
