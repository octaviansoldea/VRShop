...
inline float degrees2Radians(float aflDegrees)	{return ((float)PI / 180.0f) * aflDegrees;}
inline double degrees2Radians(double adbDegrees)	{return ((double)PI / 180.0) * adbDegrees;}

inline float radians2degrees(float aflRadians)	{return aflRadians * 180.0f / (float)PI;}
